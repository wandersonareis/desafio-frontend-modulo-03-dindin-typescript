...
A página está disponível no seguinte link: [https://desafio-frontend-modulo-03-dindin-typescript-t01-ten.vercel.app](https://desafio-frontend-modulo-03-dindin-typescript-t01-ten.vercel.app)

# Deploy da API

A API está disponível no seguinte link: [https://dead-rose-seahorse-suit.cyclic.app](https://dead-rose-seahorse-suit.cyclic.app)

# Documentação da API

A documentação da API pode ser acessada no link a seguir: [https://dead-rose-seahorse-suit.cyclic.app/docs/https://dead-rose-seahorse-suit.cyclic.app/docs](https://backend-nest-ts-cubospay.onrender.com/docs)

# Desafio | Front-end - Módulo 3 - Typescript
...
Você encontrará a documentação da api nesse link: https://github.com/cubos-academy/documentacao-api-dindin/tree/master

O link da api é esse: [https://desafio-backend-03-dindin.pedagogico.cubos.academy/](https://desafio-backend-03-dindin.pedagogico.cubos.academy/)
